...
const Home = () => {
	...
	const handleKeyPress = (e) => {             
		...
		if (e.key === "Enter" && inputValue.trim() !== ""){ 		//trim se asegura que el texto no este vacio
			addTask(inputValue);
			setInputValue("");
		}
	};
	...
	const deleteTask = (index) => {                 // deleteTask toma como parámetro index (posicion de la tarea para eliminar)
	...
	return (
	<>
		<div className="container todo" style={{ width: "400px"}} >
			<h1>To Do List</h1>
	    </div>
		<div className="container tasks" style={{ width: "400px"}}>
		    ...
		    <ul className="todoList">
			    {tasks.length === 0 ? ( <li>No tasks available</li> ) : (tasks.map((task, index) => (      //si la longitud de la tarea es igual a 0 entonces se mostara "li", de lo contrario añadira la tarea nueva
					<li key={index}
